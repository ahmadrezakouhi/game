...
<div class="w3-content w3-margin-top w3-center ">
    ...
    <h5  class="persian w3-padding-large" style="margin-top: 100px">لطفا از بین حروف انتخاب نشده , یک حرف را برای خود برگزینید؟</h5>
<div class=" " style="margin-top: 100px;">
    <button class="w3-large bold w3-card-4 w3-button w3-black w3-padding-large w3-round  chooseable w3-margin-right" id="h"  >H</button>
    <button class="w3-large bold  w3-button w3-gray w3-padding-large w3-round w3-margin-right w3-opacity">P</button>
    <button class="w3-large bold w3-card-4 w3-button w3-black w3-padding-large w3-round chooseable w3-margin-right" id="m">M</button>
    <button class="w3-large bold w3-card-4 w3-button w3-black w3-padding-large w3-round chooseable w3-margin-right" id="o">O</button>
    ...
    <button class="w3-large bold w3-card-4 w3-button w3-black w3-padding-large w3-round chooseable w3-margin-right" id="g">G</button>
    <button class="w3-large bold  w3-button w3-gray w3-padding-large w3-round w3-margin-right w3-opacity ">A</button>
</div>
    ...
    <form action="" class="w3-center w3-hide">
           ...
           <div class="" style="margin:auto; max-width: 200px">
               ...
               <div id="danger" class="persian w3-text-red font-weight-bold w3-hide" dir="rtl">  حرف انتخاب شده با حرف نوشته شده یکی نمی باشد !!!</div>
           </div>
