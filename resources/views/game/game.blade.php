...
@section('content')
    ...
    <script>
        ...
        var questions = [{
            ...
            {
                question:"اگر تعداد لغاتی که یک کودک چهار ساله می داند را در قالب و صفحه ی استاندارد و به صورت یکطرفه بنویسیم، تخمین می زنید حدودا به چند ورق نیاز داشته باشیم ؟",
                answer: 6,
                min: 0,
                max: 1000
            },
