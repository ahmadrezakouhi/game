...
@section('content')
    ...
    <div class="w3-content w3-center w3-justify persian " style="margin-top: 200px;">
        ...
        <div id="guide1" class="w3-xlarge guide" dir="rtl" style="line-height: 50px">
            ...
            <br>
            در طی 20 ثانیه می بایست تخمین های خود را
            <br>
                ...
                <div class="w3-row" style="">
                    <div class="w3-col l1  ">
                        <div class="  w3-right-align w3-xlarge"
                            style="margin-top:0px; font-weight: bold;position: relative;top:-1px" id="min">0</div>
                    </div>
                    ...
                    <div class="w3-col l1 ">
                        <div class=" w3-left-align w3-xlarge"
                            style="margin-top:0px;font-weight: bold;position: relative;top:-1px" id="max">150</div>
                    </div>
