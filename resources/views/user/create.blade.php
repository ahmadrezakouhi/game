    ...
    <div class="container mb-5" style="margin-top:90px">
        @if (Session::has('message'))
            <div class="position-fixed bottom-0 right-0 p-3" style="z-index: 5; right: 0; bottom: 0;">
                <div id="toast" class="toast hide border border-success" role="alert" aria-live="assertive"
                    aria-atomic="true" data-delay="2000" style="width: 250px">
                ...
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="custom-control custom-checkbox clearfix">
                        <div class="float-right">
                            <input type="checkbox" class="custom-control-input " id="can_play" name="can_play" style="">
                    ...
                    <div class="custom-control custom-checkbox clearfix mt-3">
                        <div class="float-right">
                            <input type="checkbox" class="custom-control-input " id="can_answer" name="can_answer" style="">
